...
var Executor = /** @class */ (function () {
    ...
    Executor.prototype.handleResultsPostingToPlatform = function (results, git) {
        return __awaiter(this, void 0, void 0, function () {
            var fails, warnings, messages, markdowns, failureCount, messageCount, dangerID, failed, previousComments, _i, previousComments_1, comment, s, are, previousComments, inline, inlineLeftovers, regular, mergedResults, issueURL, comment, urlForInfo, successPosting;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.platform.supportsHandlingResultsManually() && this.platform.handlePostingResults)) return [3 /*break*/, 2];
                        this.d("Posting via handlePostingResults");
                        return [4 /*yield*/, this.platform.handlePostingResults(results, this.options)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2:
