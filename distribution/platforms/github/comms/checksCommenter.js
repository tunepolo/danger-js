...
exports.GitHubChecksCommenter = function (api) {
    ...
    return {
        ...
        supportsHandlingResultsManually: function () { return true; },
        handlePostingResults: function (results, options) { return __awaiter(_this, void 0, void 0, function () {
            var token, custom, pr, checkData, response, error_1;
        ...
        updateStatus: function () { return Promise.resolve(true); },
        getInlineComments: function () { return Promise.resolve([]); },
        createComment: function () { return Promise.resolve({}); },
        createInlineComment: function () { return Promise.resolve({}); },
        updateInlineComment: function () { return Promise.resolve({}); },
        deleteMainComment: function () { return Promise.resolve(true); },
        deleteInlineComment: function () { return Promise.resolve(true); },
        updateOrCreateComment: function () { return Promise.resolve("NOOP"); },
    };
};
