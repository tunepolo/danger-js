...
var BitBucketServer = /** @class */ (function () {
    ...
    BitBucketServer.prototype.supportsHandlingResultsManually = function () {
        return false;
    };
    /**
    ...
    BitBucketServer.prototype.updateOrCreateComment = function (dangerID, newComment) {
        return __awaiter(this, void 0, void 0, function () {
            var comments, issue, _i, comments_2, comment, host, prURL;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.getDangerComments(dangerID)];
                    case 1:
                    ...
                    case 9:
                        ...
                        prURL = this.api.getPRBasePath();
                        return [2 /*return*/, issue && issue.id && "" + host + prURL + "/diff#comment-" + issue.id];
                }
            });
        });
    };
